(() => {
  ...
  var InnerParse = class {
    constructor(parser5, parse, overlay, target, ranges) {
      this.parser = parser5;
      this.parse = parse;
      this.overlay = overlay;
      this.target = target;
  ...
  var Language = class {
    constructor(data, parser5, topNode, extraExtensions = []) {
      this.data = data;
  ...
  var LRLanguage = class extends Language {
    constructor(data, parser5) {
      super(data, parser5, parser5.topNode);
      this.parser = parser5;
    }
    static define(spec) {
  ...
  var Parse = class {
    constructor(parser5, input, fragments, ranges) {
      ...
      this.stacks = [Stack.start(this, parser5.top[0], from2)];
      this.fragments = fragments.length && this.stream.end - from2 > parser5.bufferLength * 4 ? new FragmentCursor2(fragments, parser5.nodeSet) : null;
    }
    get parsedPos() {
